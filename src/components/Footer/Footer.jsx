          ...
          <div className="footerBlok1">
            ...
            <div className="socialNetwork">
              <a
                ...
                target="_blank"
              >
                <i class="fa fa-twitter colerSocialNet"></i>
              </a>
              <a
                className="tvitera"
                href="https://www.instagram.com/"
                target="_blank"
              >
                <i class="fa fa-instagram colerSocialNet"></i>
              </a>
              <a
                className="tvitera"
                href="https://www.instagram.com/"
                target="_blank"
              >
                <i class="fab fa-bitcoin colerSocialNet"></i>
              </a>
              <a
                className="tvitera"
                href="https://www.instagram.com/"
                target="_blank"
              >
                <i class="fab fa-apple-pay colerSocialNet"></i>
              </a>
            </div>
          </div>
